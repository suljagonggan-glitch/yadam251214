  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-sans">
      ...
      <div className="w-full md:w-[400px] bg-white border-r border-slate-200 p-6 flex flex-col shrink-0 h-auto md:h-screen md:overflow-y-auto sticky top-0 z-10">
        ...
        {isApiKeyMissing && (
           <div className="mb-6 bg-slate-800 border border-slate-700 rounded-lg p-4 text-sm text-white flex flex-col gap-2 shadow-lg">
               ...
               <p className="text-slate-300 text-xs leading-relaxed">
                   오른쪽 화면의 가이드에 따라<br/> 
                   <code className="bg-slate-900 px-1 py-0.5 rounded text-indigo-400 font-mono">.env</code> 
                   파일을 설정해주세요.
               </p>
           </div>
        )}
      ...
      {/* Right Panel */}
      <div className="flex-1 bg-slate-50 overflow-y-auto h-auto md:h-screen relative">
        <div className="max-w-4xl mx-auto h-full flex flex-col p-4 md:p-8">
          ...
          {currentBatch.length > 0 ? (
            <div className="space-y-8 pb-12">
              ...
              {/* Image List Logic ... (No changes here) */}
            ...
            <>
            {isApiKeyMissing ? (
                /* MISSING API KEY SCREEN - Styled like the user's screenshot */
                <div className="flex-1 flex flex-col items-center justify-center min-h-[50vh]">
                     <div className="bg-[#1a1c29] text-white w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden border border-slate-700">
                         {/* Header */}
                         <div className="text-center p-8 pb-4">
                             <h1 className="text-3xl md:text-4xl font-black mb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">
                                유튜브 롱폼 이미지 생성기
                             </h1>
                             ...
                             <div className="flex justify-center gap-3 mt-6">
                                 <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noreferrer" className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded font-bold text-sm transition-colors flex items-center gap-2">
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"></path></svg>
                                    API 키 발급 가이드
                                 </a>
                                 <a href="#" className="bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-2 rounded font-bold text-sm transition-colors flex items-center gap-2">
                         ...
                         {/* Box Area */}
                         <div className="p-6 md:p-8 bg-[#1e2030] border-t border-slate-700">
                             ...
                             <div className="space-y-4">
                                 ...
                                 <div className="flex items-start gap-3">
                                     <span className="text-xl">💰</span>
                                     <div>
                                         <p className="text-blue-400 font-bold text-sm mb-1">API 비용 안내</p>
                                         <ul className="text-slate-400 text-xs space-y-1 list-disc list-inside">
                                             <li>Gemini API 무료 등급에서 이미지 생성 기능을 제공합니다.</li>
                                             <li>분당 요청 수만 지키면 무료로 사용 가능합니다.</li>
                                         </ul>
                                     </div>
                                 </div>
                             </div>
